...
def main() -> int:
    ...
    parser.add_argument("--data", required=True, help="Path to dataset (CSV, Parquet, JSON, etc.)")
    ...
    parser.add_argument("--models", nargs="+", help="Specific models to try (default: all)")
    parser.add_argument("--output", default="pipeline_results.json", help="Output JSON path")
    parser.add_argument("--impute", default="auto", choices=["auto", "mean", "median"], help="Missing value strategy")
    parser.add_argument("--scaling", default="standard", choices=["standard", "minmax", "robust"], help="Scaling method")
    parser.add_argument("--encoding", default="auto", choices=["auto", "onehot"], help="Encoding method")
    ...
    print(f"Running AutoML pipeline...")
